...
func TestValidateEntityConfig_Invalid(t *testing.T) {
	invalidConfig := EntityConfig{
		...
		Caching: CachingConfig{
			...
			ListInvalidation:        "expire", // <-- Set to 'expire' to trigger the check
			MaxItemsCount:           5,
		},
	}
	...
	expectedErrors := []string{
		...
		"caching type 'redis' is not implemented yet",
		...
		"when listInvalidation is 'expire', listExpirationSeconds must be 60 or less",
	}
