...
// PostRepository defines the interface for the Post DAL.
...
func (d *PostDAL) CreateTable(ctx context.Context) error {
...
func (d *PostDAL) tableExists(ctx context.Context, db *sql.DB) (bool, error) {
	query := `
		SELECT 1
