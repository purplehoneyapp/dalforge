...
func NewPostRepository(provider DBProvider, cacheProvider CacheProvider,
    configProvider ConfigProvider, dbSettings gobreaker.Settings) PostRepository {
...
created,updated)
	...
	entity.ID = id
	dbRequestsCounter.WithLabelValues("post", operation).Inc()
