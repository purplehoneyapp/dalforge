...
Version [e874e4fe484d6909246cb2bbd70c5371dcc37cad254aec9e72b33c21e4eb8175]
*/
package dal
...
type UserRepository interface {
    ...
    ListByBday(ctx context.Context, birthdate sql.NullTime, startID int64, pageSize int) ([]*User, error)
    CountListByBday(ctx context.Context, birthdate sql.NullTime, ) (int64, error)
    ...
    ListByStatus(ctx context.Context, status sql.NullString, startID int64, pageSize int) ([]*User, error)
    CountListByStatus(ctx context.Context, status sql.NullString, ) (int64, error)
}
...
func NewUserRepository(provider DBProvider, cacheProvider CacheProvider,
    configProvider ConfigProvider, dbSettings gobreaker.Settings) UserRepository {
...
created,updated)
	...
	entity.ID = id
	dbRequestsCounter.WithLabelValues("user", operation).Inc()
...
func (d *userRepository) ListByBday(ctx context.Context, birthdate sql.NullTime, startID int64, pageSize int) ([]*User, error) {
    if d.configProvider.BlockedReads("user") {
        return nil, ErrOperationBlocked
    }
...
func (d *userRepository) ListByStatus(ctx context.Context, status sql.NullString, startID int64, pageSize int) ([]*User, error) {
    if d.configProvider.BlockedReads("user") {
        return nil, ErrOperationBlocked
    }
...
// Count function for the specific list
func (d *userRepository) CountListByBday(ctx context.Context, birthdate sql.NullTime, ) (int64, error) {
	if d.configProvider.BlockedReads("user") {
		return 0, ErrOperationBlocked
	}
...
// Count function for the specific list
func (d *userRepository) CountListByStatus(ctx context.Context, status sql.NullString, ) (int64, error) {
	if d.configProvider.BlockedReads("user") {
		return 0, ErrOperationBlocked
	}
