...
Version [5661c4771dedc7ee43e63a96cbd95820d394fd34115f4848dc76e2f0fef54a0e]
*/
package dal
...
func (d *userRepository) Store(ctx context.Context, entity *User) (*User, error) {
    ...
    if entity.ID == 0 {
        ...
        // Check unique field: uuid
        if existing == nil && entity.Uuid != "" {
            existing, _ = d.GetByUuid(ctx, entity.Uuid)
        }
