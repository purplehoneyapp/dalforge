...
Version [891795c244d90fdcb09899c29425a90326bb748f0807d77a7c06df02713892bd]
*/
package dal
...
// UserRepository defines the interface for the User DAL.
...
func (d *UserDAL) CreateTable(ctx context.Context) error {
...
func (d *UserDAL) tableExists(ctx context.Context, db *sql.DB) (bool, error) {
	query := `
		SELECT 1
